...
export const RouletteView: React.FC = () => {
    const { lists, settings, updateSettings, history, addToHistory, clearHistory } = useRouletteStore();
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg p-6 h-full flex flex-col relative overflow-hidden">
             ...
             <div className="flex justify-between items-center mb-6 z-10">
                 <h2 className="text-2xl font-bold text-gray-800 truncate pr-4">{selectedList.name}</h2>
